const images1 = [
    'static/IMGFL1.JPG.jpeg',
    'static/IMGFL2.JPG.jpeg',
    'static/IMGFL3.JPG.jpeg',
    'static/IMGFL4.JPG.jpeg',
    'static/IMGFL5.JPG.jpeg',
    'static/IMGFL6.JPG.jpeg'
];
var currentIndex1 = 0;
...
const prevButton6 = document.getElementById('prev-button6');
const nextButton6 = document.getElementById('next-button6');
function update6() {
    slideshowImage6.src = images6[currentIndex6];
}
if(nextButton6){
    nextButton6.addEventListener('click', () => {
    currentIndex6 = (currentIndex6+ 1) % images6.length; // Loop back to the last image
    update6();
    });
}
if(prevButton6){
    prevButton6.addEventListener('click', () => {
    currentIndex6 = (currentIndex6 - 1 + images6.length) % images6.length; // Loop back to the last image
    update6();
    });
}   